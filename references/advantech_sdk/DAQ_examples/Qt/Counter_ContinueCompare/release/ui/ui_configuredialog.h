...
public:
    ...
    void setupUi(QDialog *ConfigureDialog)
    {
        ...
        lblHostname->setGeometry(QRect(12, 12, 61, 20));
        ...
        btnLogin->setGeometry(QRect(253, 12, 51, 21));
    ...
    {
        ConfigureDialog->setWindowTitle(QCoreApplication::translate("ConfigureDialog", "Continue Compare - Configuration", nullptr));
