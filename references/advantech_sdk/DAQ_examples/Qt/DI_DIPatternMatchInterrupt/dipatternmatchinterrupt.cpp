...
void DIPatternMatchInterrupt::ConfigureDevice()
{
    ...
    QStringList strs;
    strs << tr("Matched No#") << tr("DI ports value (Port 0~") +
            QString("%1").arg(instantDiCtrl->getPortCount() - 1) + tr(")");
...
void DIPatternMatchInterrupt::OnDiSnapEvent(void *, DiSnapEventArgs * args, void * userParam)
{
