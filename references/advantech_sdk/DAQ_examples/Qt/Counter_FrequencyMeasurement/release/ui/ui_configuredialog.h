...
public:
    ...
    void setupUi(QDialog *ConfigureDialog)
    {
        ...
        btnCancel->setGeometry(QRect(190, 190, 61, 23));
        btnCancel->setAutoDefault(false);
        frame = new QFrame(ConfigureDialog);
        frame->setObjectName(QString::fromUtf8("frame"));
        frame->setGeometry(QRect(20, 50, 291, 121));
    ...
    {
        ConfigureDialog->setWindowTitle(QCoreApplication::translate("ConfigureDialog", "Frequency Measurement - Configuration", nullptr));
