/********************************************************************************
** Form generated from reading UI file 'asynonebufferedai_tdtrtp.ui'
**
...
#ifndef UI_ASYNONEBUFFEREDAI_TDTRTP_H
#define UI_ASYNONEBUFFEREDAI_TDTRTP_H
...
public:
    ...
    void setupUi(QDialog *AsynOneBufferedAI_TDtrClass)
    {
        ...
        btnGetData->setGeometry(QRect(605, 486, 111, 23));
        ...
        lblXCoordinateEnd->setGeometry(QRect(623, 410, 90, 16));
        ...
        lblShift->setGeometry(QRect(62, 483, 51, 16));
        ...
        edtDivValue->setGeometry(QRect(381, 480, 51, 22));
        ...
        listWidget->setGeometry(QRect(115, 430, 475, 38));
        ...
        lblDiv->setGeometry(QRect(351, 483, 31, 16));
        ...
        lblColor->setGeometry(QRect(55, 430, 61, 38));
        ...
        sldShift->setGeometry(QRect(195, 481, 128, 21));
        ...
        edtShiftValue->setGeometry(QRect(116, 480, 51, 22));
        ...
        lblDivUnit->setGeometry(QRect(437, 483, 16, 16));
        ...
        btnConfigure->setGeometry(QRect(605, 447, 111, 23));
        ...
        lblXCoordinateStart->setGeometry(QRect(55, 411, 71, 16));
        ...
        lblShiftUnit->setGeometry(QRect(172, 484, 16, 16));
        ...
        sldDiv->setGeometry(QRect(458, 480, 128, 21));
        ...
        label_triggerPoint = new QLabel(AsynOneBufferedAI_TDtrClass);
        label_triggerPoint->setObjectName(QString::fromUtf8("label_triggerPoint"));
        label_triggerPoint->setGeometry(QRect(80, 380, 121, 16));
        label_triggerPoint->setMinimumSize(QSize(121, 16));
        label_triggerPoint->setMaximumSize(QSize(121, 16));
        triggerPointFlag = new QFrame(AsynOneBufferedAI_TDtrClass);
        triggerPointFlag->setObjectName(QString::fromUtf8("triggerPointFlag"));
        triggerPointFlag->setGeometry(QRect(50, 370, 16, 21));
        triggerPointFlag->setMinimumSize(QSize(16, 21));
        triggerPointFlag->setMaximumSize(QSize(16, 31));
        triggerPointFlag->setAutoFillBackground(false);
        triggerPointFlag->setStyleSheet(QString::fromUtf8("background:url(:/AsynOneBufferedAI_TDtrtp/Resources/trigger.png)"));
        triggerPointFlag->setFrameShape(QFrame::StyledPanel);
        triggerPointFlag->setFrameShadow(QFrame::Raised);
        triggerPointFlag->raise();
        btnGetData->raise();
        lblXCoordinateEnd->raise();
        lblShift->raise();
        lblYCoordinateMid->raise();
        edtDivValue->raise();
        listWidget->raise();
        lblYCoordinateMax->raise();
        lblDiv->raise();
        lblColor->raise();
        lblYCoordinateMin->raise();
        sldShift->raise();
        edtShiftValue->raise();
        lblDivUnit->raise();
        btnConfigure->raise();
        graphFrame->raise();
        lblXCoordinateStart->raise();
        lblShiftUnit->raise();
        sldDiv->raise();
        label_triggerPoint->raise();
    ...
    {
        AsynOneBufferedAI_TDtrClass->setWindowTitle(QCoreApplication::translate("AsynOneBufferedAI_TDtrClass", "Asynchronous One Buffered AI with Trigger Delay to Start and Delay toStop", nullptr));
...
"channels:", nullptr));
        ...
        label_triggerPoint->setText(QCoreApplication::translate("AsynOneBufferedAI_TDtrClass", "0 ms Triggered.", nullptr));
    } // retranslateUi
...
#endif // UI_ASYNONEBUFFEREDAI_TDTRTP_H
