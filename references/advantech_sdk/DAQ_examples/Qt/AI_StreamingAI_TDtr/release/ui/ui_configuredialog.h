...
public:
    ...
    void setupUi(QDialog *ConfigureDialog)
    {
        ...
        ConfigureDialog->resize(620, 450);
        ConfigureDialog->setMinimumSize(QSize(620, 450));
        btnOK = new QPushButton(ConfigureDialog);
        btnOK->setObjectName(QString::fromUtf8("btnOK"));
        btnOK->setGeometry(QRect(350, 410, 75, 25));
        ...
        cmbDevice->setGeometry(QRect(58, 10, 211, 21));
        ...
        txtProfilePath->setGeometry(QRect(330, 10, 181, 20));
        lblDevice = new QLabel(frame);
        lblDevice->setObjectName(QString::fromUtf8("lblDevice"));
        lblDevice->setGeometry(QRect(12, 10, 41, 20));
        ...
        grpTriggerSetting->setGeometry(QRect(300, 50, 281, 145));
        ...
        grpTriggerSetting_2->setGeometry(QRect(300, 200, 281, 141));
        ...
        lblChannelCount->setGeometry(QRect(10, 90, 81, 21));
        ...
        lblRateUnit->setGeometry(QRect(245, 190, 21, 22));
        ...
        cmbValueRange->setGeometry(QRect(100, 140, 141, 21));
        ...
        cmbChannelStart->setGeometry(QRect(100, 40, 141, 21));
        ...
        edtClockRatePerChan->setGeometry(QRect(100, 190, 141, 21));
        ...
        lblValueRange->setGeometry(QRect(10, 140, 71, 16));
        ...
        lblClockRate->setGeometry(QRect(10, 190, 61, 16));
        ...
        edtSectionLength->setGeometry(QRect(100, 240, 141, 21));
    ...
    {
        ConfigureDialog->setWindowTitle(QCoreApplication::translate("ConfigureDialog", "Streaming AI with Trigger Delay to Start - Configuration", nullptr));
