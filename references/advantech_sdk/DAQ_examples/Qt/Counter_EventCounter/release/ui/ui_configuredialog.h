...
public:
    ...
    void setupUi(QDialog *ConfigureDialog)
    {
        ...
        ConfigureDialog->resize(350, 230);
        ...
        cmbCounterChannel->setGeometry(QRect(60, 90, 181, 21));
        ...
        cmbDevice->setGeometry(QRect(60, 10, 181, 21));
        ...
        lblHostname->setGeometry(QRect(9, 14, 61, 20));
        ...
        cmbHostName->setGeometry(QRect(80, 12, 181, 22));
    ...
    {
        ConfigureDialog->setWindowTitle(QCoreApplication::translate("ConfigureDialog", "Event Counter - Configuration", nullptr));
