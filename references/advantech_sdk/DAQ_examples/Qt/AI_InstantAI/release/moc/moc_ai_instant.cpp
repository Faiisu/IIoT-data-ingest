...
QT_MOC_LITERAL(5, 49, 18), // "ButtonStartClicked"
QT_MOC_LITERAL(6, 68, 22), // "ButtonConfigureClicked"
QT_MOC_LITERAL(7, 91, 19), // "ButttonPauseClicked"
QT_MOC_LITERAL(8, 111, 17) // "ButtonStopClicked"

    },
    "AI_Instant\0TimerTicked\0\0SliderValueChanged\0"
    "value\0ButtonStartClicked\0"
...
void AI_Instant::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AI_Instant *>(_o);
        (void)_t;
        switch (_id) {
        ...
        case 4: _t->ButttonPauseClicked(); break;
        case 5: _t->ButtonStopClicked(); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject AI_Instant::staticMetaObject = { {
    ...
    qt_meta_stringdata_AI_Instant.data,
    qt_meta_data_AI_Instant,
    qt_static_metacall,
    nullptr,
    nullptr
} };
