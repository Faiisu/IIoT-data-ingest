...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(ContinueCompare parrent) {
		...
		cmbHostName.setBounds(84, 22, 166, 21);
		contentPanel.add(cmbHostName);
		
		btnLogin = new JButton("Login");
		btnLogin.setBounds(255, 20, 80, 23);
	...
	protected void SetEditUIEnable(boolean enable) {
		...
		cmbCountingType.setEnabled(enable);
