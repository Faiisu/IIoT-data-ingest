...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(PulseOutputWithTimerInterrupt parrent) {
		...
		cmbHostName.setBounds(82, 15, 149, 21);
		contentPanel.add(cmbHostName);
		
		btnLogin = new JButton("Login");
		btnLogin.setBounds(254, 15, 80, 23);
	...
	class ButtonLoginActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!hostName.equals(localEdge)) {
				if (ErrorCode.Success == timerPulseCtrl.Login(hostName)) {
