...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(StreamingAI_Retrigger parrent) {
		...
		panel.setBounds(283, 108, 311, 164);
		...
		panel_1.setBounds(283, 283, 311, 165);
		...
		lblProfileName.setBounds(276, 69, 50, 15);
		contentPanel.add(lblProfileName);
		
		btnBrowse = new JButton("Browse");
		btnBrowse.setBounds(518, 65, 78, 23);
	...
	protected void SetEditUIEnable(boolean enable) {		
		...
		txtProfileName.setEnabled(enable);
