...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(DIPatternMatchInterrupt parrent) {
		...
		btnOK.setBounds(108, 318, 69, 23);
		btnOK.addActionListener(new ButtonOKActionListener());
		contentPanel.add(btnOK);
		
		JButton btnCancel = new JButton("Cancel");
		btnCancel.setBounds(216, 318, 75, 23);
		...
		btnLogin.setBounds(238, 14, 75, 23);
	...
	protected void SetEditUIEnable(boolean enable) {	
		...
		enablePort.setIsEditable(enable);
		pattern.setIsEditable(enable);
	}
