...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(DIStatusChangeInterrupt parrent) {
		...
		lblProfile.setBounds(10, 53, 54, 15);
	...
	protected void SetEditUIEnable(boolean enable) {
		...
		cmbPort.setEnabled(enable);
		onePort.setIsEditable(enable);
	}
