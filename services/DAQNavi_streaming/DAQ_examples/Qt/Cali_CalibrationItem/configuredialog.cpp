...
void ConfigureDialog::Initailization()
{
    ...
    Array<DeviceTreeNode> *supportedDevices = caliCtrl->getSupportedDevices();
...
void ConfigureDialog::DeviceChanged()
{
   ...
   ErrorCode errorCode = caliCtrl->setSelectedDevice(selected);
   ...
   Array<CaliSolution>* slnList = caliCtrl->getSolutions();
