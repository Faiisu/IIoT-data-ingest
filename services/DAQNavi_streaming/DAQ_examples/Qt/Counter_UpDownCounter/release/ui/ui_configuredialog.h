...
public:
    ...
    void setupUi(QDialog *ConfigureDialog)
    {
        ...
        btnOK->setGeometry(QRect(80, 220, 75, 23));
        btnCancel = new QPushButton(ConfigureDialog);
        btnCancel->setObjectName(QString::fromUtf8("btnCancel"));
        btnCancel->setGeometry(QRect(170, 220, 75, 23));
        btnCancel->setAutoDefault(false);
        frame = new QFrame(ConfigureDialog);
        frame->setObjectName(QString::fromUtf8("frame"));
        frame->setGeometry(QRect(20, 50, 291, 151));
        ...
        cmbHostName->setGeometry(QRect(81, 18, 161, 22));
        ...
        btnLogin->setGeometry(QRect(250, 20, 51, 21));
    ...
    {
        ConfigureDialog->setWindowTitle(QCoreApplication::translate("ConfigureDialog", "UpDown Counter - Configuration", nullptr));
