...
public:
    ...
    void setupUi(QDialog *ConfigureDialog)
    {
        ...
        btnOK->setGeometry(QRect(110, 180, 61, 23));
        btnCancel = new QPushButton(ConfigureDialog);
        btnCancel->setObjectName(QString::fromUtf8("btnCancel"));
        btnCancel->setGeometry(QRect(190, 180, 61, 23));
        btnCancel->setAutoDefault(false);
        frame = new QFrame(ConfigureDialog);
        frame->setObjectName(QString::fromUtf8("frame"));
        frame->setGeometry(QRect(32, 50, 281, 121));
        ...
        lblProfilePath->setGeometry(QRect(6, 50, 41, 21));
        ...
        cmbDevice->setGeometry(QRect(56, 10, 161, 21));
        ...
        lblHostname->setGeometry(QRect(20, 12, 61, 20));
    ...
    {
        ConfigureDialog->setWindowTitle(QCoreApplication::translate("ConfigureDialog", "Pulse Width Measurement - Configuration", nullptr));
