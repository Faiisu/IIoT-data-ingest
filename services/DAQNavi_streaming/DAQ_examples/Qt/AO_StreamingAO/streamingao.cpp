    ...
    : QDialog(parent, flags)
{
    ...
    connect(buttonGroup1, SIGNAL(buttonPressed(QAbstractButton *)), this, SLOT(WaveButtonClicked(QAbstractButton *)));
...
void StreamingAO::OnStoppedEvent(void *, BfdAoEventArgs *, void * userParam)
{
   StreamingAO *uParam = (StreamingAO *)userParam;
   uParam->stophandle();
}

void StreamingAO::OnUnderrunEvent(void *, BfdAoEventArgs *, void * userParam)
{
   StreamingAO *uParam = (StreamingAO *)userParam;
...
void StreamingAO::WaveButtonClicked(QAbstractButton *btn)
{
