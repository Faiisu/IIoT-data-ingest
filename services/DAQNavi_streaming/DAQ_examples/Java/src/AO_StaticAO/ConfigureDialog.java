...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(StaticAO parrent) {
		...
		panel_1.setBounds(10, 80, 243, 121);
		...
		cmbHostName.setBounds(84, 15, 274, 21);
		getContentPane().add(cmbHostName);
		
		btnLogin = new JButton("Login");
		btnLogin.setBounds(368, 15, 87, 23);
	...
	class ButtonLoginActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!hostName.equals(localEdge)) {
				if (ErrorCode.Success == instantAo.Login(hostName)) {
