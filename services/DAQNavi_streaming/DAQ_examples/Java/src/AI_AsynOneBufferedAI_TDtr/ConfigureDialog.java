...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(AsynOneBufferedAI_TDtr parrent) {
		...
		pnlTrigger1Parameter.setBounds(290, 209, 283, 149);
