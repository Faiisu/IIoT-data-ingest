...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(AsynOneBufferedAI_TDtp parrent) {
		...
		pnlParameter.setBounds(12, 96, 250, 190);
		...
		pnlTriggerParameter.setBounds(274, 96, 280, 190);
	...
	class ComboBoxTriggerIndexListener implements ItemListener{
		...
		@Override
		public void itemStateChanged(ItemEvent e) {
			if (cmbTriggerIndex.getItemCount() < 1) {
				return;
			}
	...
	protected void SetEditUIEnable(boolean enable) {
		...
		cmbTriggerIndex.setEnabled(enable);
