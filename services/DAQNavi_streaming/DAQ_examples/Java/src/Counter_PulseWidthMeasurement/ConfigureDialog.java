...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(PulseWidthMeasurement parrent) {
		...
		cmbHostName.setBounds(76, 15, 166, 21);
		contentPanel.add(cmbHostName);
		
		btnLogin = new JButton("Login");
		btnLogin.setBounds(251, 15, 80, 23);
	...
	class ButtonLoginActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!hostName.equals(localEdge)) {
				if (ErrorCode.Success == pwMeterCtrl.Login(hostName)) {
