...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(DIInterrupt parrent ) {
		...
		scrollPanel.setBounds(10, 175, 325, 122);
	...
	class ButtonOKActionListener implements ActionListener{
		public void actionPerformed(ActionEvent arg0) {
			...
			configure.hostName = cmbHostName.getSelectedItem().toString();
	...
	protected void SetEditUIEnable(boolean enable) {
		...
		for(int i = 0; i < diPortUI.length; i++){
			diPortUI[i].setIsEditable(enable);
			diPortUI[i].setIsEditable(enable);
		}		
	}
