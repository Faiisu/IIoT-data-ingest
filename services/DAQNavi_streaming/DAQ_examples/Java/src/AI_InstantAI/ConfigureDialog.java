...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(InstantAI parrent) {
		...
		lblNewLabel.setBounds(22, 54, 64, 15);
		getContentPane().add(lblNewLabel);
		
		JPanel panel = new JPanel();
		panel.setBackground(SystemColor.control);
		panel.setBounds(10, 112, 358, 129);
	...
	class ButtonLoginActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!hostName.equals(localEdge)) {
				if (ErrorCode.Success == instantAi.Login(hostName)) {
