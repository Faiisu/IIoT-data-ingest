...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(SynchronousOneWaveformAO parrent) {
		...
		panel_1.setBounds(26, 79, 277, 172);
		...
		cmbHostName.setBounds(76, 15, 370, 21);
		getContentPane().add(cmbHostName);
		
		btnLogin = new JButton("Login");
		btnLogin.setBounds(456, 15, 89, 23);
