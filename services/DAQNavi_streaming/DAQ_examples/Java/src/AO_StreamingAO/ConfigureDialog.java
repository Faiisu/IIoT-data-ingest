...
public class ConfigureDialog extends JDialog {
	...
	public ConfigureDialog(StreamingAO parrent) {
		...
		panel_1.setBounds(10, 83, 256, 125);
	...
	protected void SetEditUIEnable(boolean enable) {
		...
		txtPointCount.setEnabled(enable);
		txtClockRate.setEnabled(enable);
	}
	...
	class ButtonLoginActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!hostName.equals(localEdge)) {
				if (ErrorCode.Success == bufferedAoCtrl.Login(hostName)) {
