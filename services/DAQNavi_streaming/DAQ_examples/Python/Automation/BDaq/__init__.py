...
from ctypes import Structure, c_uint8, c_int32, c_double, c_int64, c_wchar, c_void_p, cast, byref, POINTER, py_object

import platform
if platform.system().lower() == 'windows':
    from ctypes import WINFUNCTYPE as DaqEventCallback
else:
    from ctypes import CFUNCTYPE as DaqEventCallback
...
class SignalDrop(IntEnum):
    ...
    SigDiPatternMatch0 = 702
    SigDiPatternMatch1 = 703
    SigDiPatternMatch2 = 704
    SigDiPatternMatch3 = 705
    SigDiPatternMatch4 = 706
    SigDiPatternMatch5 = 707
    SigDiPatternMatch6 = 708
    SigDiPatternMatch7 = 709
    SigDiPatternMatch8 = 710
    SigDiPatternMatch9 = 711
    SigDiPatternMatch10 = 712
    SigDiPatternMatch11 = 713
    SigDiPatternMatch12 = 714
    SigDiPatternMatch13 = 715
    SigDiPatternMatch14 = 716
    SigDiPatternMatch15 = 717
    SigDiPatternMatch16 = 718
    SigDiPatternMatch17 = 719
    SigDiPatternMatch18 = 720
    SigDiPatternMatch19 = 721
    SigDiPatternMatch20 = 722
    SigDiPatternMatch21 = 723
    SigDiPatternMatch22 = 724
    SigDiPatternMatch23 = 725
    SigDiPatternMatch24 = 726
    SigDiPatternMatch25 = 727
    SigDiPatternMatch26 = 728
    SigDiPatternMatch27 = 729
    SigDiPatternMatch28 = 730
    SigDiPatternMatch29 = 731
    SigDiPatternMatch30 = 732
    SigDiPatternMatch31 = 733

    # device internal clock
    SigInternal16384KHz = 734

    #signals for fusion device
    SigSyncJunction = 735
    SigConvClkJunction = 736
    SigClkDivJunction = 737
    SigTrgStrJunction = 738
    SigTrgStpJunction = 739
    SigAcqStaJunction = 740
