...
- Store raw voltage and calibrated measurement with physical unit association (calibration revision metadata is retired). A new calibration applies to future samples; historical records retain their original interpretation and can be reanalysed from raw voltage.
